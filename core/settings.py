...
SECRET_KEY = 'django-insecure-+n&o8ob*7z@x!1+lh_)scddwnt0!@6a+psx*ea&4%-dmfvt**&'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:5173",  # Include this if you're using Vite
]
...
# This tells WhiteNoise to compress the files for faster loading
